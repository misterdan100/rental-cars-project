...
export default function Features() {
  return (
    <div className="max-w-6xl mx-auto p-6 lg:py-40">
        ...
        <p className="max-w-lg mt-5 lg:mt-10 lg:mb-16 text-xl">We are all about our client's conform and safety. That's why we provide the best service you can imagen</p>
